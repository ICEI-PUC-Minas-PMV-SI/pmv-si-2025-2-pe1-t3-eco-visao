...
|RF-005| O sistema deve ter um mapa interativo onde seja possível colocar marcadores específicos para denunciar um ou mais problemas em uma localização designada | MÉDIA |
...
|RF-008| O sistema deve ter um banco de dados com CRUD  | ALTA |
